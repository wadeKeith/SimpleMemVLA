...
class SeqOfColorsEnv(BaseEnv):
    ...
    def evaluate(self):
        ...
        success = (
            all_cubes_from_sequence_is_touched & no_one_cube_not_from_sequence_is_touched & self.agent.is_static(0.2)
        )
    ...
    def compute_dense_reward(self, obs: Any, action: Array, info: Dict):
        ...
        # TODO: 1. add static reward
        # TODO: 2. add info about correct / wrong touches
...
@register_env("SeqOfColors3-v0", max_episode_steps=120)
class SeqOfColors3Env(SeqOfColorsEnv):
    SEQUENCE_LENGTH = 3


@register_env("SeqOfColors5-v0", max_episode_steps=120)
class SeqOfColors5Env(SeqOfColorsEnv):
    SEQUENCE_LENGTH = 5


@register_env("SeqOfColors7-v0", max_episode_steps=120)
class SeqOfColors7Env(SeqOfColorsEnv):
    SEQUENCE_LENGTH = 7
